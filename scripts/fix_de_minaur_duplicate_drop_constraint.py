...
Temporarily drops and recreates the constraint
"""

import psycopg2

def fix_de_minaur_duplicate_drop_constraint():
    """Merge A de Minaur into Alex de Minaur by temporarily dropping the constraint"""
    ...
    try:
        ...
        print("Temporarily dropping valid_winner constraint...")
        cur.execute("ALTER TABLE matches DROP CONSTRAINT valid_winner")
        ...
        print("Re-creating valid_winner constraint...")
        cur.execute("""
            ALTER TABLE matches 
            ADD CONSTRAINT valid_winner 
        ...
        # Make sure to re-create constraint even if there's an error
        try:
            cur.execute("""
                ALTER TABLE matches 
                ADD CONSTRAINT valid_winner 
                CHECK ((winner_id = player1_id) OR (winner_id = player2_id))
            """)
            print("Re-created constraint after error")
        except:
            pass
...
if __name__ == "__main__":
    fix_de_minaur_duplicate_drop_constraint()
